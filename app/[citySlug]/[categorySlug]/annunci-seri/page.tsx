...
interface SeriListingsPageProps {
...
export async function generateMetadata({ params: paramsPromise }: SeriListingsPageProps): Promise<Metadata> {
...
export default async function AnnunciSeriPage({ params: paramsPromise }: SeriListingsPageProps) {
  const { citySlug, categorySlug } = await paramsPromise; // Await the params
